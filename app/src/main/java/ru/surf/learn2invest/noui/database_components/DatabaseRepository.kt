...
object DatabaseRepository {
    ...
    // AssetInvest
    fun getAllAsFlowAssetInvest(): Flow<List<AssetInvest>> = assetInvestDao.getAllAsFlow()
    ...
    suspend fun deleteAssetInvest(entity: AssetInvest) = assetInvestDao.delete(entity)

    suspend fun getBySymbolAssetInvest(symbol: String) = assetInvestDao.getBySymbol(symbol)


    // profile
    fun getAllAsFlowProfile(): Flow<List<Profile>> = profileDao.getAllAsFlow()

    suspend fun insertAllProfile(vararg entities: Profile) =
        profileDao.insertAll(entities = entities)

    suspend fun updateProfile(vararg entities: Profile) = profileDao.update(entities = entities)

    suspend fun deleteProfile(entity: Profile) = profileDao.delete(entity)


    // searchedCoin
    fun getAllAsFlowSearchedCoin(): Flow<List<SearchedCoin>> = searchedCoinDao.getAllAsFlow()
    ...
    suspend fun deleteSearchedCoin(entity: SearchedCoin) = searchedCoinDao.delete(entity)
    ...
    // transaction
    fun getAllAsFlowTransaction(): Flow<List<Transaction>> = transactionDao.getAllAsFlow()
    ...
    suspend fun deleteTransaction(entity: Transaction) = transactionDao.delete(entity)
